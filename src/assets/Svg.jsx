  ...
  return (
    <div>
      ...
      >
        ...
        <circle
          id="blue-dot-3"
          classNameName="cls-1 dot left-side"
          cx="2"
          cy="89.29"
          r="2"
        />
        <circle
          id="red-dot-4"
          classNameName="cls-3 dot left-side"
          cx="24.6"
          cy="89.79"
          r="2"
        />
        ...
        <circle
          id="yellow-dot"
          classNameName="cls-2 dot left-side"
          cx="31.1"
          cy="55.99"
          r="2"
        />
        ...
        <circle
          id="mint-dot-1"
          classNameName="cls-4 dot left-side"
          cx="43.2"
          cy="22.29"
          r="2"
        />
