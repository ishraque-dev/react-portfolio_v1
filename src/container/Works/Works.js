...
const Works = () => {
  ...
  const handleWorkFilter = (item) => {
    ...
    setTimeout(() => {
      setAnimateCart([{ y: 100, opacity: 1 }]);
      if (item === 'ALL') {
        setFilterWork(works);
      } else {
        setFilterWork(
  ...
  return (
    <div className="app__works" id="work">
      <h1 className="head-text">My Creative Portfolio Section</h1>
      ...
      >
        {filterWork.map((work, i) => (
          <div className="app__work-item app__flex" key={i}>
            ...
            <div className="app__flex app__work-content">
